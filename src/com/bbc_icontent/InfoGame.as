package com.bbc_icontent
{
	...
	public class InfoGame
	{
		...
		public static const LEVEL_ELEPHANT:String = 'level_elephant';
		...
		public static const LEVEL_SNAKE:String = "level_snake";
		...
		public static function initializeInfo():void{
			labels[LEVEL_ALL] = 'na';
			labels[LEVEL_ELEPHANT] = 'K…l‡Ki \n †ÿZ';
			labels[LEVEL_ROOMFLOOR] = '†Ljvi \n gvV';
			labels[LEVEL_STAIRS] = 'cyi‡bv \n eb';
			labels[LEVEL_ROOM_DOWNSTAIRS] = 'MÖv‡gi \n wm‡bgv nj';
			labels[LEVEL_KITCHEN] = 'e¨¯Í \n evRvi';
			
			levelendMessage[LEVEL_ELEPHANT] = '`viæY! dm‡ji †¶‡Z ¸ßab †LvuRvi P¨v‡jÄwU Zzwg m¤úbœ K‡i‡Qv| Zzwg cybivq GB P¨v‡jÄwU‡Z Ask wb‡Z cv‡iv, A_ev cieZ©x P¨v‡j‡Ä GwM‡q †h‡Z cv‡iv|';
			...
			scoreFeedbackMessages[SCORE_FEEDBACK_A] = 'AmvaviY!!! Zzwg GKRb `y`©všÍ wg_ ev÷vi| gvwmK wel‡q Zzwg †ek fvjB Rv‡bv|';
			scoreFeedbackMessages[SCORE_FEEDBACK_B] = '`viæY! Zzwg GKRb fv‡jv wg_ ev÷vi| Z‡e Zzwg AviI fv‡jv Ki‡Z cv‡iv| Zvn‡j Avi GKevi †MgwU †L‡jB †`‡Lv bv|';
			scoreFeedbackMessages[SCORE_FEEDBACK_C] = 'In ‡nv! wg_ ev÷vi nIqvi Rb¨ †Zvgv‡K Avi GKevi †MgwU †Lj‡Z n‡e| Zvn‡jB Zzwg eyS‡Z cvi‡e gvwmK wel‡q †KvbwU mwVK Avi †KvbwU fzj aviYv|';
